...
Sightengine นำโมเดลตระกูล **CNNs (Convolutional Neural Networks)** หรือสถาปัตยกรรมเช่น ResNet มาวิเคราะห์หารอยต่อลายน้ำ (Artifacts) ที่หลบซ่อนอยู่ในรูปภาพจาก AI

**ทฤษฎีทางสถิติ - Binary Classification:**
- โมเดลถูกเทรนผ่านโครงข่ายประสาทเพื่อคายผลลัพธ์ออกมาเป็นค่าความน่าจะเป็น (Probability) ว่าภาพอยู่ในคลาส 0 (ภาพถ่ายปกติ) หรือคลาส 1 (AI สร้าง)
- พารามิเตอร์สุดท้ายจะผ่านฟังก์ชันสถิติ **Sigmoid** 
$$ \sigma(z) = \frac{1}{1 + e^{-z}} $$
- สกอร์ที่ได้จะอยู่ระหว่าง 0 ไป 1 (`0.98` = น่าจะเป็นภาพ AI 98%) โดยอัลกอริทึมเรียนรู้คำนวณผ่าน **Binary Cross-Entropy Loss** ตลอดการรับฟีดรูปภาพเป็นแสนๆ ใบทำให้โมเดลมีความแม่นยำสูง
