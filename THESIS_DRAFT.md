...
เป็นฟังก์ชันการรักษาความปลอดภัยของพื้นที่ประมูล ทำงานประสานกับการสร้างโพสต์สินค้าเพื่อสร้างเสถียรภาพในการคัดกรองเนื้อหาปนเปื้อนและการหลอกลวง
*   **การทำงาน:** ทุกครั้งที่มีการอัปโหลดไฟล์เข้าระบบ ภาพจะถูกส่งเข้าไปคำนวณผ่าน Image Manipulation Detection (วิเคราะห์ 17 สัญญาณทางสถิติ) ตลอดจนการใช้โมเดลวิเคราะห์ภาพชั้นลึก (CNN Externals)
*   **การตรวจสอบแหล่งที่มา (Reverse Image Search):** ขนานกันนั้น ระบบยังมีการตรวจจับภาพซ้ำซ้อนเพื่อป้องกันการขโมยรูปภาพสินค้าจากเว็บไซต์อื่นมาแอบอ้าง (เช่น การดูดรูปมาจากตลาดนอกอย่าง Mercari หรือ Yahoo Auctions JP)
*   **การแสดงผลลัพธ์:** หากตัวแบบประเมินพบว่าภาพดังกล่าวมีเปอร์เซ็นต์ความเป็น "ภาพที่สร้างจาก AI" (AI-Generated), มีร่องรอยตัดต่อที่ไม่โปร่งใส (Manipulated), หรือเป็นภาพหลอกลวงที่คัดลอกมาจากเว็บไซต์อื่น ระบบจะแสดงแถบคำเตือนภัยสีแจ้งให้ทราบว่ารูปภาพมีความเสี่ยงระดับสูง และอาจปฏิเสธการโพสต์ดังกล่าว
*(ผู้จัดทำสามารถแทรกภาพหน้าจอ: ข้อความแจ้งเตือน (Warning Modal) เมื่อระบบจับได้ว่ามีการอัปโหลดภาพปลอม ภาพจาก AI หรือภาพสินค้าที่ถูกขโมยมาจากเว็บอื่น)*
