...
const Login: React.FC = () => {
  ...
  const handleGoogleLogin = async (): Promise<void> => {
    try {
      ...
      // Browser จะ redirect ไป Google — ไม่ต้อง navigate เอง
    } catch (err: any) {
      ...
      <div className="w-full max-w-md">
        ...
        <div className="card bg-base-100 border border-base-300 shadow-xl">
          <div className="card-body p-8">
            <h2 className="text-center text-2xl font-bold mb-1">เข้าสู่ระบบ</h2>
            <p className="text-center text-sm text-base-content/60 mb-6">เข้าสู่ระบบเพื่อซื้อขายการ์ดเกม</p>
            ...
            <div className="form-control mb-6">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="password-toggle-btn absolute right-2 top-1/2 -translate-y-1/2"
          ...
          <button
            ...
            className="btn btn-outline w-full h-12 gap-2 mb-4"
          >
            {googleLoading ? (
              <span className="loading loading-spinner loading-sm" />
            ) : (
          ...
          <p className="text-center text-sm text-base-content/70 m-0">
            ยังไม่มีบัญชี?{' '}
            <Link to="/register" className="link link-primary font-bold no-underline">
              สมัครสมาชิก
            </Link>
          </p>
          </div>
